...
public class MyView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        paint.setStrokeWidth(3);//设置画笔的笔触宽度
        //绘制圆形
        canvas.drawCircle(40, 40, 30, paint);//要画圆的圆心的x坐标
//        canvas.drawCircle(width/2, height/2, width/2-10, paint);//要画圆的圆心的x坐标
        // 绘制正方形
        ...
        RectF rectF = new RectF(10, 530, 70, 580);
        canvas.drawArc(rectF, 0, 130, true, paints);//切记坐标轴是倒着的
        /**
         * ----------设置填充风格后绘制----------
         */
        ...
        // ----------设置渐变器后绘制----------
        // 为Paint设置渐变器
        @SuppressLint("DrawAllocation") Shader mShader = new LinearGradient(0, 0, 40, 60
                , new int[]{
